...
int main() {
    int num_processes, quantum, choice;
    ...
    if (choice == 1) {
        ...
        sort_by_priority(processes, num_processes); // Sort processes by priority
        avg_waiting_time_ps = priority_scheduling(processes, num_processes);
    ...
    printf("Comparing the two scheduling algorithms...\n");
